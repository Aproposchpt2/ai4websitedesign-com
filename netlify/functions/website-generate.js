// AI4 Website Design Studio — Website Generation (Powered by Apropos Group LLC).
...
const COPY_SYSTEM = `You are a professional website copywriter working for AI4 Website Design Studio (Apropos Group LLC). You will receive intake data about a business and generate polished, professional website copy that would impress a Fortune 500 prospect. Every line must be specific to this business — never generic. Generate copy for these sections:
